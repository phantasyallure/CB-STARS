...
import {
  IconBox, IconTruck, IconReceipt, IconLayers, IconChart, IconChat, IconUsers, IconSettings,
...
const NAV = [
  ...
  { to: 'delivery', perm: 'products', icon: IconTruck, fr: 'Livraison', en: 'Delivery' },
    ...
    <div className="adm">
      ...
      <aside className="adm-side" data-open={menuOpen}>
        <div className="adm-side__brand">
          <span className="signature adm-side__logo">CB Stars</span>
      ...
      <div className="adm-main">
        <header className="adm-top">
          ...
          <span className="signature adm-top__logo">CB Stars</span>
        </header>
