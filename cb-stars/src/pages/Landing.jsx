    ...
    <div className="landing">
      ...
      <section className="hero">
        ...
        <div className="container hero__inner">
          <h1 className="hero__sig" aria-label="CB Stars">
            <span className="signature hero__sig-text" aria-hidden="true">CB Stars</span>
          </h1>
          <svg className="hero__swash" viewBox="0 0 700 40" preserveAspectRatio="none" aria-hidden="true">
            <path pathLength="1" d="M6 26 C 90 6, 190 34, 320 20 S 560 8, 694 22" />
          </svg>
          <p className="hero__line">{t('hero.line')}</p>
      ...
      <footer className="landing__footer">
        <div className="container landing__footer-inner">
          <div>
            <span className="signature landing__footer-brand">CB Stars</span>
            <p className="landing__footer-tagline">{t('footer.tagline')}</p>
          </div>
          <p className="landing__footer-rights">© {new Date().getFullYear()} CB Stars — {t('footer.rights')}</p>
        </div>
      </footer>
