...
// Keys are identical across languages so t('hero.line') works in any of them.
// The admin panel is bilingual (French / English) and uses tx(fr, en) inline.

export const translations = {
  fr: {
    meta: {
      title: 'CB Stars — Vêtements et chaussures',
    },
    nav: {
      language: 'Choisir la langue',
    },
    hero: {
      line: 'Vêtements et chaussures, livrés partout en Algérie.',
    ...
    footer: {
      tagline: 'Vêtements et chaussures, livrés partout en Algérie.',
  ...
  en: {
    meta: {
      title: 'CB Stars — Clothing and shoes',
    },
    nav: {
      language: 'Choose language',
    },
    hero: {
      line: 'Clothing and shoes, delivered across Algeria.',
    ...
    footer: {
      tagline: 'Clothing and shoes, delivered across Algeria.',
  ...
  ar: {
    meta: {
      title: 'CB Stars — ملابس وأحذية',
    },
    nav: {
      language: 'اختيار اللغة',
    },
    hero: {
      line: 'ملابس وأحذية، توصيل إلى جميع أنحاء الجزائر.',
      cta: 'تصفّح المجموعة',
    },
    trust: {
    ...
    footer: {
      tagline: 'ملابس وأحذية، توصيل إلى جميع أنحاء الجزائر.',
